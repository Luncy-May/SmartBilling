...
const About = () => {
  ...
  return (
    <div className="text-4xl font-serif font-bold text-white pl-[10vw] space-y-10 p-3 mt-[5vh] overflow-hidden">
    <div className='pt-5 space-y-5 text-4xl font-bold flex flex-col items-center justify-center'>About</div>
